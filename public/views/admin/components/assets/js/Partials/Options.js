$(document).ready(function () {
            ...
            return ` <div class="dropdown dropdown-inline" >
                         ...
                         <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right" style="width: 150px">
                              <ul class="nav nav-hoverable flex-column">
                                  <li class="nav-item">
                                     <a class="nav-link btnEditOption" href="javascript:;" data-id='${full.id}'>
  ...
  // Edit begin
  let preloaded = [];
  $("body").on("click", ".btnEditOption", function () {
    let id = $(this).data("id");
    console.log(id);
    //TODO: optiıon düzenleme işlemi
