...
!(function ($) {
  ...
  (Dashboard.prototype.createAreaChart = function (
    ...
    (Dashboard.prototype.createLineChart1 = function (
      element,
      data,
      xkey,
      ykeys,
    ...
    (Dashboard.prototype.init = function () {
      ...
      this.createAreaChart(
        ...
        ["#fcbe2d", "#02c58d", "#30419b"]
      );

      //creating donut chart
      var $donutData = [
        { label: "Kategori 1", value: 12 },
        { label: "Kategori 2", value: 30 },
        { label: "Kategori 3", value: 20 },
      ];
      this.createDonutChart("category_by_sales", $donutData, [
        "#fcbe2d",
        "#30419b",
        "#02c58d",
      ]);
